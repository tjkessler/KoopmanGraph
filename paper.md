...
- **Tutorials and tests.** Sixteen Jupyter notebooks, Sphinx API reference, pytest suite with an enforced 90% coverage gate, and nbmake smoke tests in CI.
