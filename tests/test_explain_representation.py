...
def test_explain_representation_rejects_delay_models() -> None:
    """Delay embeddings are outside the homogeneous explain MVP."""
    ...
    with pytest.raises(ValueError, match="n_delays"):
        explain_representation(model, data, epochs=1)
